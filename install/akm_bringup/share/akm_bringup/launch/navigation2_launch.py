...
def generate_launch_description():
    fishbot_navigation2_dir = get_package_share_directory('akm_bringup')
    ...
    nav2_param_path = LaunchConfiguration('params_file',default=os.path.join(fishbot_navigation2_dir,'params','navigation2.yaml'))

    rviz_config_dir = os.path.join(fishbot_navigation2_dir,'rviz','navigation2.rviz')
